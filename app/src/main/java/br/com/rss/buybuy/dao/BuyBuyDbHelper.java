...
public class BuyBuyDbHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_LISTA_BASE = "CREATE TABLE IF NOT EXISTS lista_base (id INTEGER PRIMARY KEY, produto_id INTEGER, frequencia_id INTEGER, quantidade DOUBLE, flag_ativo BOOLEAN, FOREIGN KEY(produto_id) REFERENCES produto(id), FOREIGN KEY(frequencia_id) REFERENCES frequencia(id));";
    public static final String SQL_DELETE_LISTA_BASE = "DROP TABLE IF EXISTS lista_base;";
    public static final String SQL_CREATE_LOJA = "CREATE TABLE IF NOT EXISTS loja (id INTEGER PRIMARY KEY, nome VARCHAR, localizacao VARCHAR, flag_ativo BOOLEAN);";
